use crate::node::simple_rnode::{RootedZetaNode, RootedTreeNode};
    ...
    <Self as RootedTree<'a>>::Node: RootedZetaNode,
{
    fn set_zeta(
        &'a mut self,
        zeta_func: fn(&Self, <<Self as RootedTree<'a>>::Node as RootedTreeNode>::NodeID) -> <<Self as RootedTree<'a>>::Node as RootedZetaNode>::Zeta,
    );
    fn get_zeta(
        &'a self,
    ...
    fn is_zeta_set(&self, node_id: <<Self as RootedTree<'a>>::Node as RootedTreeNode>::NodeID) -> bool;
    // {
